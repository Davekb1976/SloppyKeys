...
# mark_done decrements daily allowance only for the played slot when spent=True
...
assert t_daily.reads[2].runs_remaining == 10
assert t_daily.reads[2].state == STATE_RUNNABLE
assert t_daily.reads[3].runs_remaining == 10
