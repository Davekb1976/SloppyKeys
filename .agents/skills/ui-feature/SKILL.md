...
name: ui-feature
description: >-
  Build or change a screen, panel, modal or block row in the pywebview UI. Covers the
  four-layer split (shell / appearance / render / data), the component checklist, the design
  tokens, and the traps specific to having a live game window on top of the page. Use when
  adding a UI surface, restyling one, or wiring a control to the Python bridge.
---
